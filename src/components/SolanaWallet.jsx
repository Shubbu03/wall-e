...
function SolanaWallet() {
  ...
  const createNewSOLWallet = () => {
    ...
    setWallets([...wallets, { account, publicKey }]);
  };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="space-x-4">
            ...
            <button
              ...
              className="bg-purple-600 hover:bg-purple-500 text-white font-bold py-2 px-4 rounded transition duration-300"
            >
              ETH Wallet
            </button>
          </div>
      ...
      <main className="flex-grow flex flex-col items-center justify-start p-8">
        {mnemonic ? (
          <>
            <h1 className="text-4xl font-bold mb-6">Your Solana Wallets</h1>
            <div className="flex space-x-4 mb-8">
              <button
                onClick={createNewSOLWallet}
